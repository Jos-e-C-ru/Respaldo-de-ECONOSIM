...
namespace Econosim
{
    public partial class resultados_informe_de_produccion_ : Form
    {
        string SSCadenaConexion = "Data Source = DESKTOP-LPK0UAA; Initial Catalog = proyecto_grupo_#3; Integrated security = true ";

        public resultados_informe_de_produccion_()
        {
            InitializeComponent();
        }

        private void resultados_informe_de_produccion__Load(object sender, EventArgs e)
        {
        ...
        private DataTable llenargrid(string CadenaConexion)
        {
            ...
            sqlcon1.Open();
            sqlcom1 = new SqlCommand("produccio_de_marca", sqlcon1);
